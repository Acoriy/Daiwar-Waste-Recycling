  ...
  const foundersList = [
    {
      ...
      expertise: t("20 years of expertise in sustainable innovation", "20 عامًا من الخبرة في الابتكار المستدام"),
      image: Zaki_Alqasemi,
    ...
    },
    {
      ...
      expertise: t("Expert in green project financing", "خبير في تمويل المشاريع الخضراء"),
